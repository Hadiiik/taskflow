...
>
      ...
      <Link className=" bg-white text-violet-600 py-2 px-6 rounded-md text-lg hover:bg-violet-700 hover:text-white hover:shadow-md transition duration-300 my-4 focus:bg-slate-300 focus:text-white  "
      href={"/login"}>
        جرب الآن
      </Link>
    </section>
