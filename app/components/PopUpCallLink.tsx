  ...
  return (
    <>
      ...
      <div className="fixed inset-0 flex items-center justify-center z-50">
        <div
          className={`bg-white rounded-lg shadow-lg w-96 transition-transform duration-500 ${
            isShrinking ? 'scale-0' : 'scale-100'
          }`}
        >
          {/* Header */}
          <div className="bg-gradient-to-r from-purple-500 to-purple-700 rounded-t-lg p-4">
