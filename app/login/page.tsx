...
const page = () => {
    ...
    return (
        <div className="max-w-md mx-auto p-6 bg-violet-900 rounded-xl shadow-2xl m-12">
            <h2 className="text-3xl font-bold text-center text-violet-50 mb-8 ">تسجيل الدخول</h2>
            ...
            <p className="mt-4 text-center text-violet-200 text-sm">
                لا تملك حساب؟{' '}
                <Link href="/signup" className="text-amber-400 hover:text-amber-300 focus:text-slate-500">انشاء حساب؟</Link>
            </p>
        </div>
    );
};
